...
class DartTableResolver extends LocalElementResolver<DiscoveredDartTable> {
  ...
  Future<DriftElement> resolve() async {
    ...
    final table = DriftTable(
      ...
      fixedEntityInfoName: dataClassInfo.entityName,
      ...
      nameOfDaoClass: dataClassInfo.daoClassName,
      nameOfDaoGetter: dataClassInfo.daoGetterName,
      nameOfServiceClass: dataClassInfo.serviceClassName,
      nameOfServiceGetter: dataClassInfo.serviceGetterName,
      daoCustomClass: dataClassInfo.daoCustomClass,
      serviceCustomClass: dataClassInfo.serviceCustomClass,
